...
export interface ApiBillBill extends Schema.CollectionType {
  ...
  attributes: {
    register_number: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    register_date: Attribute.Date &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    speaker: Attribute.Relation<
      ...
      'api::deputy.deputy'
    >;
    law_documents: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    attached_documents: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBroadcastBroadcast extends Schema.SingleType {
...
export interface ApiChairmanChairman extends Schema.SingleType {
  collectionName: 'chairmans';
  info: {
    singularName: 'chairman';
    pluralName: 'chairmans';
    displayName: '\u0417\u0430\u043C\u0435\u0441\u0442\u0438\u0442\u0435\u043B\u0438 \u0422\u043E\u0440\u0430\u0433\u0430';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiDeputyDeputy extends Schema.CollectionType {
  ...
  attributes: {
    ...
    socialLinks: Attribute.Component<'data.social-links', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFractionFraction extends Schema.CollectionType {
...
export interface ApiToragaToraga extends Schema.SingleType {
  collectionName: 'toragas';
  info: {
    singularName: 'toraga';
    pluralName: 'toragas';
    displayName: '\u0422\u043E\u0440\u0430\u0433\u0430';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::toraga.toraga': ApiToragaToraga;
    }
  }
}
